...
class FlussoAvnMobilitaAnagServiceTest {
    ...
    @Autowired
    private ConfigurazioneFlussoAvnMobilitaAnag configurazioneFlusso;
    @InjectMocks
    @Spy
    private FlussoAvnMobilitaAnagService flusso;
    @Mock
    ...
    private RecordDtoAvnMobilitaAnag recordDto;
//    private ConfigurazioneFlussoAvnMobilitaAnag configurazione;
    ...
    @BeforeEach
    void init() {
        recordDto = new RecordDtoAvnMobilitaAnag();
    ...
    void validazioneBlocchiTestModalitaT_OK() {
        ...
        ConfigurazioneFlussoAvnMobilitaAnag configurazioneFlussoSism = new ConfigurazioneFlussoAvnMobilitaAnag();
    ...
    @Test
    void validazioneBlocchiTestModalitaT_KOInfoAnagrafiche() {
        ...
        doThrow(IllegalArgumentException.class).when(tracciatoSplitter).creaInformazioniAnagrafiche(any(), any());
