...
import it.mds.sdk.flusso.avn.mobilita.anag.controller.FlussoAvnMobilitaAnagControllerRest;
...
public class ControllerTest {
    ...
    @InjectMocks
    @Spy
    private FlussoAvnMobilitaAnagControllerRest controller;
    ...
    @Mock
    private FlussoAvnMobilitaAnagService service;
    private ConfigurazioneFlussoAvnMobilitaAnag.Rules rules = mock(ConfigurazioneFlussoAvnMobilitaAnag.Rules.class);

    private ConfigurazioneFlussoAvnMobilitaAnag.Flusso flusso = mock(ConfigurazioneFlussoAvnMobilitaAnag.Flusso.class);
    ...
    private ConfigurazioneFlussoAvnMobilitaAnag.NomeFlusso nomeFlusso = Mockito.mock(ConfigurazioneFlussoAvnMobilitaAnag.NomeFlusso.class);
