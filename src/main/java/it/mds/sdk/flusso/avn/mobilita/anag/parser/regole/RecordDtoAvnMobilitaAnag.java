...
@Data
public class RecordDtoAvnMobilitaAnag extends RecordDtoGenerico {

    //MOD_INV~COD_REG~ID_ASS~VLD_COD_ID~TIP_COD_ID~COD_SEX~DAT_NSC~COD_CMN_RES~COD_ASL_RES~COD_REG_RES~COD_STT_RES~DAT_TRA_RES~COD_CMN_DOM~COD_ASL_DOM~COD_REG_DOM~CITT~DAT_DEC~TIP_TRASM_ANAG
    ...
    @CsvBindByPosition(position = 3) //VLD_COD_ID
