...
package it.mds.sdk.flusso.avn.mobilita.anag.exception;
...
@Slf4j
public class ApiAvnMobilitaAnagExceptionHandler {
...
//        public ResponseEntity<String> handleApiParseCSVException(Exception e) {
//        log.debug(e.getMessage(), e);
//        return new ResponseEntity<>("Si è verificato un errore.", HttpStatus.I_AM_A_TEAPOT);
//    }
}
