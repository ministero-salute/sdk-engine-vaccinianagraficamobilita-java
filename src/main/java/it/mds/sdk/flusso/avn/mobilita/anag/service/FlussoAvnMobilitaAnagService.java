...
package it.mds.sdk.flusso.avn.mobilita.anag.service;
...
import it.mds.sdk.flusso.avn.mobilita.anag.parser.regole.ParserTracciatoImpl;
...
@Slf4j
@Component("flussoAvnMobilitaAnagService")
public class FlussoAvnMobilitaAnagService {
    ...
    private TracciatoSplitter<RecordDtoAvnMobilitaAnag> tracciatoSplitter;
    private ConnettoreMds connettoreMds;
    private ConfigurazioneFlussoAvnMobilitaAnag conf;
    private Crittografia crittografia;
    private final String CATEGORIA_FLUSSI = "AVT";
    private final String NOME_FILE_XSD_AVN = "AVM.xsd";
    private ModalitaOperativa ModalitaOperativa;

    private final Configurazione config = new Configurazione();

    @Autowired
    public FlussoAvnMobilitaAnagService(@Qualifier("parserRegoleAvnMobilitaAnag") final ParserRegole parserRegole,
                                        ...
                                        @Qualifier("tracciatoSplitterAvnMobAnag") final TracciatoSplitter<RecordDtoAvnMobilitaAnag> tracciatoSplitter,
                                        @Qualifier("connettoreMds") final ConnettoreMds connettoreMds,
                                        @Qualifier("configurazioneFlussoAvnMobilitaAnag") final ConfigurazioneFlussoAvnMobilitaAnag conf,
    ...
    public void validazioneBlocchi(int dimensioneBlocco, String nomeFile, RegoleFlusso regoleFlusso, String idRun,
        ...
        String nomeFileXml = conf.getXmlOutput().getPercorso() + "SDK_AVT_AVM_" + periodoRiferimento + "_" + idRun + ".xml";
        ...
        do {
            ...
            List<RecordDtoAvnMobilitaAnag> recordConv =
                    bloccoValidazione.getRecordList().stream().map(k -> (RecordDtoAvnMobilitaAnag) k).collect(Collectors.toList());
